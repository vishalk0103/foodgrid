  ...
  return (
    <div className={style.content}>
      <div className={style.cart}>
        ...
        {cartItems.length === 0 && (
          <EmptyCart
            button={
              <button
                className={`btn text-white ${style["cart--btn"]}`}
                disabled
              >
                <strong>CHECKOUT</strong>
              </button>
      ...
      <div className={style.foodItem}>
        ...
        {props.foods
          .filter((food) => food.category === "main course")
          .map((food) => (
            <FoodItem
              id={food._id}
              key={food._id}
        ...
        {props.foods
          .filter((food) => food.category === "quick bites")
          .map((food) => (
            <FoodItem
              id={food._id}
              key={food._id}
        ...
        {props.foods
          .filter((food) => food.category === "extra")
          .map((food) => (
            <FoodItem
              id={food._id}
              key={food._id}
        ...
        {props.foods
          .filter((food) => food.category === "beverages")
          .map((food) => (
            <FoodItem
              id={food._id}
              key={food._id}
